...
If we restrict ourselves to only the partitions which keep the letters in alphabetic order, then we can enumerate all $\frac{25!}{18!7!}$ partitions and test them over the course of a few days on a modern computer.
